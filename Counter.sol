...
contract Example {
    ...
    // The function below is a query function for getting counter description.
    // BUT ONE THİNG İS MORE İMPORTANT HERE THE MEMORY KEYWORD!

    // Returning the current DESCRİPTİON of our counter.
